...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../cita.test-samples';

import { CitaService, RestCita } from './cita.service';

const requireRestSample: RestCita = {
  ...sampleWithRequiredData,
  horarioConsultaInicio: sampleWithRequiredData.horarioConsultaInicio?.toJSON(),
  horarioConsultaFin: sampleWithRequiredData.horarioConsultaFin?.toJSON(),
};
