...
describe('Cita Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'cita', component: CitaComponent }]), HttpClientTestingModule, CitaComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to citaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCitaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCitaIdentifier).toHaveBeenCalledWith(entity);
