...
describe('Consultorio Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'consultorio', component: ConsultorioComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.consultorios?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to consultorioService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getConsultorioIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getConsultorioIdentifier).toHaveBeenCalledWith(entity);
